...
{   //BwCrhed, SFtxmod,
	...
	{ 0x72,   0x74,    0x0c}, //16: BW125CR45SF10  Bw = 125khz,  imp header off, Cr= 4/5, Sf10 = 1024 chips/symbol, CRC on, LowDataRateOptimize  
	{ 0x42,   0x84,    0x0c}, //17: BW31_25CR45SF8 Bw = 31.25khz,imp header off, Cr= 4/5, Sf8  = 256  chips/symbol, CRC on, LowDataRateOptimize  
	{ 0x52,   0x94,    0x0c}, //18: BW41_7CR45SF9  Bw = 41.7khz, imp header off, Cr= 4/5, Sf9  = 512  chips/symbol, CRC on, LowDataRateOptimize  
	{ 0x52,   0xa4,    0x0c}, //19: BW41_7CR45SF10 Bw = 41.7khz, imp header off, Cr= 4/5, Sf10 = 1024 chips/symbol, CRC on, LowDataRateOptimize
};
...
bool RH_RF95::init()
{
    ...
    // setModemConfig(BW62_5CR46SF10);   // 13: Bw = 62.5khz, Cr = 4/6, Sf10 = 1024 chips/symbol,CRC on --> I gott a delay of:  1186 ms sending this --> GPS data
